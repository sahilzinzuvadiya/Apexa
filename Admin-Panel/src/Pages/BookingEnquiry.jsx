...
export default function BookingEnquiry() {
  ...
  <div className="flex items-center gap-2 bg-white/[0.05] border border-white/[0.08] px-4 py-2 rounded-xl shrink-0">
    ...
    <span className="text-white font-bold text-sm">{enquiries.length}</span>
    <span className="text-gray-500 text-xs">Total</span>
        ...
        {!loading && enquiries.length === 0 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            ...
            <p className="text-gray-500 text-sm mt-1">Bookings will appear here once submitted.</p>
          </motion.div>
        )}
                ...
                <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <div className="flex items-center gap-3 bg-white/[0.03] rounded-xl px-4 py-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-white text-sm font-semibold truncate">{e.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 bg-white/[0.03] rounded-xl px-4 py-3">
                    <div className="w-8 h-8 rounded-lg bg-purple-500/10 flex items-center justify-center shrink-0">
                      <svg className="w-3.5 h-3.5 text-purple-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 17l4 4 4-4m0-5H4m16 0H4m16 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
                      </svg>
                    </div>
                    <div className="min-w-0">
                      <p className="text-[9px] text-gray-500 uppercase tracking-widest mb-0.5">Car</p>
                      <p className="text-white text-sm font-semibold truncate">{e.carName}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 bg-[rgba(201,168,76,0.06)] rounded-xl px-4 py-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-[9px] text-gray-500 uppercase tracking-widest mb-0.5">Rate</p>
                      <p className="text-[#C9A84C] text-sm font-black truncate">
                        ₹{e.price} <span className="text-gray-500 font-normal text-[10px]">/km</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-white/[0.03] rounded-xl px-4 py-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-white text-sm leading-relaxed line-clamp-2">{e.message || "—"}</p>
                    </div>
                  </div>
